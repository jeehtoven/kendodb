	...
	case 1:
	{
		...
		string tsf = "kendo_db/" + alter_name + "/table_info.kendo";
  					...
  					if (found!=std::string::npos)
					{
						size_t pos = 0;	 
						string token; 
						string col_arr[99]; //Assuming the table has 99 columns maximum 
						int m = 0; 						
						...
						while(getline(table_edit,table_edit_line,';'))
                                                {
                                                        ...
                                                        if(track == digit)
                                                        {
                                                                ...
                                                                //cout << track << endl;
                                                                string value_to_erase = column_array[track] + ";";
                                                                cout << "Value to erase: " << value_to_erase << endl;
                                                                removeSubstrs(table_edit_line_sc, value_to_erase);
                                                                cout << "Parsed line: " << table_edit_line_sc << endl;
                                                        }
                                                                track++;
